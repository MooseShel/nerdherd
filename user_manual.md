...
- **Subjects**: Dynamically filtered by available courses (e.g., "CS", "MATH"). Select a subject to see only relevant Tutors and Peers.
...
### Reviews
- After a session, leave a star rating and review for your tutor to help the community.

## ⚙️ Settings & Customization
- **Appearance**: Choose **Light**, **Dark**, or **System** theme. Map markers automatically adjust for best contrast.
